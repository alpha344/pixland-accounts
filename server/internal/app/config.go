...
type Config struct {
	...
	Dev     bool
	DB      string   `default:"mongodb://localhost" envconfig:"PIXLAND_ACCOUNTS_DB"`
	DBName  string   `default:"pixland-account" envconfig:"PIXLAND_ACCOUNTS_DB_NAME"`
	Origins []string `envconfig:"PIXLAND_ACCOUNTS_ORIGINS"`
	...
	// Storage
	StorageIsLocal          bool   `envconfig:"PIXLAND_ACCOUNTS_STORAGE_IS_LOCAL"`
	StorageBucketName       string `envconfig:"PIXLAND_ACCOUNTS_STORAGE_BUCKET_NAME" default:"pixland"`
	StorageEmulatorEnabled  bool   `envconfig:"PIXLAND_ACCOUNTS_STORAGE_EMULATOR_ENABLED"`
	StorageEmulatorEndpoint string `envconfig:"PIXLAND_ACCOUNTS_STORAGE_EMULATOR_ENDPOINT"`
}
